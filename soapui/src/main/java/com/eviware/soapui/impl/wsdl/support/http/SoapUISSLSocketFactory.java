...
public class SoapUISSLSocketFactory extends SSLConnectionSocketFactory {
    ...
    public static SoapUISSLSocketFactory create(
        KeyStore keyStore,
    ...
    public Socket createSocket(HttpContext context) throws IOException {
        ...
        try {
            factory = create(getKeyAndPassword(sslConfig).getKey(), getKeyAndPassword(sslConfig).getPassword());
...
//		}
    ...
    public Socket createLayeredSocket(Socket socket, String host, int port, HttpContext context) throws IOException {
        ...
        if (StringUtils.isNullOrEmpty(sslConfigForLayeredSocket)) {
            ...
            try {
                SSLConnectionSocketFactory factory = create(getKeyAndPassword(sslConfigForLayeredSocket).getKey(),
    ...
    private final class KeyAndPassword {
        ...
        private KeyAndPassword(KeyStore key, String password) {
            this.key = key;
            this.password = password;
        }

        private KeyStore getKey() {
            return key;
        }
