...
public class AssertionCategoryMapping {
    ...
    public static String[] getAssertionCategories() {
        return new String[]{
            VALIDATE_RESPONSE_CONTENT_CATEGORY, STATUS_CATEGORY, SCRIPT_CATEGORY, SLA_CATEGORY, JMS_CATEGORY, JDBC_CATEGORY, SECURITY_CATEGORY
        };
    }
     ...
     */
    private static SortedSet<AssertionListEntry> createRecentlyUsedSet(
        Assertable assertable, RecentAssertionHandler recentAssertionHandler
    ) {
