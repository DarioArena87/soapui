...
public class TestStepTpsAssertion extends AbstractLoadTestAssertion implements Configurable {
    ...
    private void init(LoadTestAssertionConfig assertionConfig) {
        ...
        setName(reader.readString(NAME_ELEMENT, "Step TPS"));
        minRequests = reader.readInt(MIN_REQUESTS_ELEMENT, 100);
        minValue = reader.readInt(MIN_VALUE_ELEMENT, 10);
    ...
    public boolean configure() {
        ...
        values.put(MIN_VALUE_FIELD, String.valueOf(minValue));
        ...
        if (dialog.getReturnValue() == XFormDialog.OK_OPTION) {
            try {
                ...
                minValue = Integer.parseInt(values.get(MIN_VALUE_FIELD));
    ...
    protected void updateConfiguration() {
        ...
        builder.add(MIN_VALUE_ELEMENT, minValue);
    ...
    private void buildDialog() {
        ...
        form.addTextField(MIN_VALUE_FIELD, "Minimum required step TPS", FieldType.TEXT);
        ...
        dialog = builder.buildDialog(builder.buildOkCancelHelpActions(HelpUrls.STEP_TPS_LOAD_TEST_ASSERTION_HELP_URL),
                                     "Specify options for this Step TPS Assertion",
