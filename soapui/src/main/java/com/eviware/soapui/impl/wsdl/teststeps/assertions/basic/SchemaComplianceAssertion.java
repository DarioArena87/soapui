...
public class SchemaComplianceAssertion extends WsdlMessageAssertion implements RequestAssertion, ResponseAssertion {
    ...
    private static final Map<String, WsdlContext> wsdlContextMap = new HashMap<String, WsdlContext>();
    ...
    public void prepare(TestCaseRunner testRunner, TestCaseRunContext testRunContext) throws Exception {
        ...
        PropertyExpansionContext context = testRunContext.hasProperty(TestCaseRunContext.LOAD_TEST_CONTEXT) ? (PropertyExpansionContext)testRunContext.getProperty(
            TestCaseRunContext.LOAD_TEST_CONTEXT) : testRunContext;
    ...
    public static class Factory extends AbstractTestAssertionFactory {
        public Factory() {
            super(ID, LABEL, SchemaComplianceAssertion.class);
        }
        ...
        public boolean canAssert(Assertable assertable) {
            try {
                return super.canAssert(assertable) &&
                       assertable.getInterface() instanceof AbstractInterface &&
