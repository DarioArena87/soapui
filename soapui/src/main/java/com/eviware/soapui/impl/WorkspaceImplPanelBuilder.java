...
public class WorkspaceImplPanelBuilder extends EmptyPanelBuilder<WorkspaceImpl> {
    ...
    public JPanel buildOverviewPanel(WorkspaceImpl workspace) {
        ...
        table.addProperty(messages.get("OverviewPanel.ProjectRoot.Label"), "projectRoot", new String[]{null, "${workspaceDir}"})
             .setDescription(messages.get("OverviewPanel.ProjectRoot.Description"));
        return table;
    }
}
