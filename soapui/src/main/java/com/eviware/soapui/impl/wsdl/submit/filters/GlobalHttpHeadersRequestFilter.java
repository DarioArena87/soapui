...
public class GlobalHttpHeadersRequestFilter extends AbstractRequestFilter {
    ...
    private static final StringToStringsMap globalHeadersToAdd = new StringToStringsMap();

    private StringToStringsMap headersToAdd;
    private final Map<AbstractHttpRequest, StringToStringsMap> savedHeaders = new HashMap<AbstractHttpRequest, StringToStringsMap>();
