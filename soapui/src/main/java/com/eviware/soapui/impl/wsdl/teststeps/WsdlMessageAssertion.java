...
public abstract class WsdlMessageAssertion extends AbstractModelItem implements PropertyExpansionContainer, TestAssertion {
    ...
    protected WsdlMessageAssertion(
    ...
    public void setConfiguration(XmlObject configuration) {
        ...
        notifyPropertyChanged(CONFIGURATION_PROPERTY, oldConfig, configuration);
    }
    ...
    public String getName() {
        return assertionConfig.isSetName() ? assertionConfig.getName() : TestAssertionRegistry.getInstance().getAssertionNameForType(assertionConfig.getType());
    }
    ...
    public AssertionStatus assertProperty(
        ...
        if (!propertyName.equals("Group") && !source.hasProperty(propertyName)) {
            assertionStatus = AssertionStatus.FAILED;
            assertionErrors = new com.eviware.soapui.model.testsuite.AssertionError[]{
                new com.eviware.soapui.model.testsuite.AssertionError("property: '" + propertyName + "' does not exist")
            };
        }
        else {
            try {
    ...
    protected abstract String internalAssertProperty(
        TestPropertyHolder source, String propertyName, MessageExchange messageExchange, SubmitContext context
