...
public class MockRunnerManagerImpl implements MockRunnerManager {
    ...
    private static final Map<String, MockRunnerManager> managers = new HashMap<String, MockRunnerManager>();

    private final Map<String, WsdlMockService> mockServices = new HashMap<String, WsdlMockService>();

    private final Vector<WsdlMockRunner> mockRunners = new Vector<WsdlMockRunner>();
