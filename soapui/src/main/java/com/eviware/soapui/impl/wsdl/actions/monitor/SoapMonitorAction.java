...
public class SoapMonitorAction extends AbstractSoapUIAction<WsdlProject> {
    ...
    protected SoapMonitor openSoapMonitor(
        WsdlProject target, int listenPort, String incomingRequestWss, String incomingResponseWss, boolean setAsProxy, String sslEndpoint
    ) {
