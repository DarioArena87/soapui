...
public class GetOAuthAccessTokenAction extends AbstractAction {
    ...
    private final OAuth2Profile target;

    public GetOAuthAccessTokenAction(OAuth2Profile target) {
        this.target = target;
        putValue(NAME, messages.get("GetOAuthAccessTokenAction.Action.Name"));
        putValue(SHORT_DESCRIPTION, messages.get("GetOAuthAccessTokenAction.Action.Description"));
    }
