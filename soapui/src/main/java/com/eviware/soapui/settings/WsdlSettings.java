...
public interface WsdlSettings {
    ...
    String XML_GENERATION_TYPE_EXAMPLE_VALUE = WsdlSettings.class.getSimpleName() + "@" + "xml-generation-type-example-value";

    @Setting(name = "Type Comment", description = "generate comments with type information in new requests", type = SettingType.BOOLEAN)
    String XML_GENERATION_TYPE_COMMENT_TYPE = WsdlSettings.class.getSimpleName() + "@" + "xml-generation-type-comment-type";
    ...
    String XML_GENERATION_ALWAYS_INCLUDE_OPTIONAL_ELEMENTS = WsdlSettings.class.getSimpleName() + "@" + "xml-generation-always-include-optional-elements";

    @Setting(name = "Pretty Print", description = "pretty print response messages", type = SettingType.BOOLEAN)
    String PRETTY_PRINT_RESPONSE_MESSAGES = WsdlSettings.class.getSimpleName() + "@" + "pretty-print-response-xml";
    ...
    String ALLOW_INCORRECT_CONTENTTYPE = WsdlSettings.class.getSimpleName() + "@" + "allow-incorrect-contenttype";
    ...
    String PRETTY_PRINT_PROJECT_FILES = WsdlSettings.class.getSimpleName() + "@" + "pretty-print-project-files";

    String XML_GENERATION_SKIP_COMMENTS = WsdlSettings.class.getSimpleName() + "@" + "xml-generation-skip-comments";
    ...
    String TRIM_WSDL = WsdlSettings.class.getSimpleName() + "@" + "trim-wsdl";
