...
public interface WSISettings {
    ...
    */
    ...
    @Setting(
        name = "Profile", description = "Specify the type of profile", type = SettingType.ENUMERATION, values = {
    ...
    @Setting(
        name = "Correlation", description = "Specify the log file correlation type", type = SettingType.ENUMERATION, values = {
