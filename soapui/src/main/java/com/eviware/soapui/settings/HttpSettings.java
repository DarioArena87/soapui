...
public interface HttpSettings {
    ...
    /*OT*/ String MAX_TOTAL_CONNECTIONS_INVALID_VALUE_ERROR_MESSAGE = "The value of Max total connections must be greater than 0.";
    /*OT*/ String MAX_CONNECTIONS_PER_HOST_INVALID_VALUE_ERROR_MESSAGE = "The value of Max connections per host must be greater than 0.";

    @Setting(
        name = "HTTP Version", description = "Select HTTP Version to use", type = SettingType.ENUMERATION, values = {
    ...
    @Setting(
        name = "Request compression", description = "", type = SettingType.ENUMERATION, values = {
        "None", CompressionSupport.ALG_GZIP, CompressionSupport.ALG_DEFLATE
    }
    )
    ...
    String DISABLE_RESPONSE_DECOMPRESSION = HttpSettings.class.getSimpleName() + "@disable_response_decompression";
    ...
    String AUTHENTICATE_PREEMPTIVELY = HttpSettings.class.getSimpleName() + "@" + "authenticate-preemptively";
    ...
    String INCLUDE_REQUEST_IN_TIME_TAKEN = HttpSettings.class.getSimpleName() + "@" + "include_request_in_time_taken";
    ...
    String INCLUDE_RESPONSE_IN_TIME_TAKEN = HttpSettings.class.getSimpleName() + "@" + "include_response_in_time_taken";
    ...
    String MAX_CONNECTIONS_PER_HOST = HttpSettings.class.getSimpleName() + "@" + "max_connections_per_host";

    @Setting(name = "Max Total Connections", description = "Maximum number of Total Connections")
    String MAX_TOTAL_CONNECTIONS = HttpSettings.class.getSimpleName() + "@" + "max_total_connections";
