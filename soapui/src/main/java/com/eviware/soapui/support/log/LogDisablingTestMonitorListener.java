...
public final class LogDisablingTestMonitorListener extends TestMonitorListenerAdapter {
    private final Set<LoadTestRunner> loadTestRunners = new HashSet<LoadTestRunner>();
    private final Set<SecurityTestRunner> securityTestRunners = new HashSet<SecurityTestRunner>();
