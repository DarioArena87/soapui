...
public class TestSuiteToTestSuiteDropHandler extends AbstractBeforeAfterModelItemDropHandler<WsdlTestSuite, WsdlTestSuite> {
    ...
    boolean moveBefore(WsdlTestSuite source, WsdlTestSuite target) {
        WsdlTestSuite testCase = moveTestSuite(source, target.getProject(), target.getProject().getIndexOfTestSuite(target));
    ...
    boolean copyAfter(WsdlTestSuite source, WsdlTestSuite target) {
        WsdlTestSuite testCase = copyTestSuite(source, target.getProject(), target.getProject().getIndexOfTestSuite(target) + 1);
    ...
    boolean moveAfter(WsdlTestSuite source, WsdlTestSuite target) {
        WsdlTestSuite testCase = moveTestSuite(source, target.getProject(), target.getProject().getIndexOfTestSuite(target) + 1);
