...
public class JEditorStatusBarWithProgress extends JEditorStatusBar {
    ...
    private void initProgressBar() {
        ...
        progressBar.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(2, 2, 2, 3), BorderFactory.createMatteBorder(0, 0, 1, 1, Color.LIGHT_GRAY)));
