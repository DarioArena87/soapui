...
public class SoapUIActionRegistry {
    private final Map<String, SoapUIAction> actions = new HashMap<String, SoapUIAction>();
    private final Map<String, SoapUIActionGroup> actionGroups = new HashMap<String, SoapUIActionGroup>();
    ...
    private SoapUIActionGroup createActionGroupClassFromConfig(SoapUIActionGroupConfig group) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException {
        ...
        Constructor<SoapUIActionGroup> constructor = actionGroupClass.getConstructor(String.class, String.class);
        if (constructor != null) {
            ...
            try {
                ...
                if (mapping.isSetGroupId()) {
                    ...
                    DefaultActionMapping actionMapping = new DefaultActionMapping(mapping.getActionId(),
                                                                                  mapping.getKeyStroke(),
                                                                                  mapping.getIconPath(),
                                                                                  mapping.getActionId().equals(groupConfig.getDefault()),
                                                                                  mapping.getParam()
                    );
    ...
    public static class SeperatorAction extends AbstractSoapUIAction {
        ...
        private static final SoapUIActionMapping defaultMapping = new DefaultActionMapping(SOAPUI_ACTION_ID, null, null, false, null);
