...
public class SoapUIListenerRegistry implements ListenerRegistry {
    ...
    private final Map<Class<?>, List<Class<?>>> listeners = new HashMap<Class<?>, List<Class<?>>>();
    private final Map<Class<?>, List<Object>> singletonListeners = new HashMap<Class<?>, List<Object>>();
    private final Map<Class<?>, SoapUIListenerConfig> listenerConfigs = new HashMap<Class<?>, SoapUIListenerConfig>();
