...
public class MaliciousAttachmentSecurityScanFactory extends AbstractSecurityScanFactory {
    ...
    public MaliciousAttachmentSecurityScanFactory() {
        super(MaliciousAttachmentSecurityScan.TYPE,
              MaliciousAttachmentSecurityScan.NAME,
              "Performs a scan for Malicious Attachment Vulnerabilities",
              "/malicious_attachment_scan.gif"
        );
    }
