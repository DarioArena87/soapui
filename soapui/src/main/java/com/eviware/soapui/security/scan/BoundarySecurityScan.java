...
public class BoundarySecurityScan extends AbstractSecurityScanWithProperties {
    ...
    private final RestrictionLabel restrictionLabel = new RestrictionLabel();
    ...
    public String extractRestrictions(
        XmlObjectTreeModel model2, SecurityTestRunContext context, XmlTreeNode nodeToUpdate, XmlObjectTreeModel model, SecurityCheckedParameter scp, StringToStringMap stsmap
    ) throws Exception {
    ...
    private void getNextChild(
        XmlTreeNode node, SecurityTestRunContext context, XmlTreeNode nodeToUpdate, XmlObjectTreeModel model, SecurityCheckedParameter scp, StringToStringMap stsmap
    ) {
