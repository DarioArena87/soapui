...
public class InvalidHttpStatusCodesAssertion extends WsdlMessageAssertion implements ResponseAssertion {
    ...
    private void buildDialog() {
        ...
        dialog = builder.buildDialog(builder.buildOkCancelHelpActions(HelpUrls.SECURITY_INVALID_HTTP_CODES_ASSERTION_HELP), "Specify codes", UISupport.OPTIONS_ICON);
    }
    ...
    public static class Factory extends AbstractTestAssertionFactory {
        ...
        public Factory() {
            super(
                ID,
                LABEL,
                InvalidHttpStatusCodesAssertion.class,
