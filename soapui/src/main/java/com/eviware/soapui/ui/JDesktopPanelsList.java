...
public class JDesktopPanelsList extends JPanel {
    private final DefaultListModel desktopPanels;
    private final JList desktopPanelsList;
    private SoapUIDesktop desktop;
    private final DesktopPanelPropertyChangeListener desktopPanelPropertyListener = new DesktopPanelPropertyChangeListener();
    private final InternalDesktopListener desktopListener = new InternalDesktopListener();
